...
func (interactor *MainController) ProcessTemplate(w http.ResponseWriter, r *http.Request, tmpl string, data Interface) {
	//infoFlashesMsgs := []string{""} // interactor.Cookie.PopFlashesInfo(w, r)
	//successFlashesMsgs := []string{""} // interactor.Cookie.PopFlashesSuccess(w, r)
	//warningFlashesMsgs := []string{""} // interactor.Cookie.PopFlashesWarning(w, r)
	//dangerFlashesMsgs :=  []string{""}  // interactor.Cookie.PopFlashesDanger(w, r)
	//
